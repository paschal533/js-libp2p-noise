 ...
 * - `noiseHFS()` - post-quantum hybrid `Noise_XXhfs_25519+MLKEM768_ChaChaPoly_SHA256` (quantum-safe forward secrecy via ML-KEM-768)
 *
 * ## Usage (classical)
 *
 ...
 * ```
 *
 * The libp2p protocol ID is `/noise-mlkem768-hfs/0.2.0`. Connections negotiated with `noiseHFS()` have quantum-safe forward secrecy: the handshake is secure if either X25519 or ML-KEM-768 is unbroken.
 *
 * ### Custom KEM backend
 *
